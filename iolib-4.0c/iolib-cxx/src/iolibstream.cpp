...
bool IOLibStream::SetMode(long mode)
{
...
#if defined __WIN32__
			if (ioctlsocket(socket, FIONBIO, &var) != 0) return false;
#else
			if (ioctl(socket, FIONBIO, &var) != 0) return false;
#endif
			break;
...
const char *IOLibStream::GetRemoteHostname()
{
#ifdef MSDOS
	return NULL;
#else
...
unsigned long IOLibStream::GetRemoteIP()
{
#ifdef MSDOS
	return 0;
#else
...
void IOLibStream::CloseSocket(SOCKET sock)
{
