...
#include <stdio.h>
	...
	const int	 STREAM_FILE		= 1;
	const int	 STREAM_POSIX		= 2;
	const int	 STREAM_ANSI		= 3;
	const int	 STREAM_WINDOWS		= 4;
	const int	 STREAM_SOCKET		= 5;
	const int	 STREAM_SERVER		= 6;
	const int	 STREAM_CLIENT		= 7;
	const int	 STREAM_STREAM		= 8;
	const int	 STREAM_BUFFER		= 9;
	const int	 STREAM_CHILD		= 10;
	const int	 STREAM_SOCKS4_CLIENT	= 11;
	const int	 STREAM_SOCKS4_BIND	= 12;
	const int	 STREAM_SOCKS5_CLIENT	= 13;
	const int	 STREAM_SOCKS5_BIND	= 14;

	const int	 STREAM_SOCKS4_NOAUTH	= 1;
	const int	 STREAM_SOCKS5_NOAUTH	= 2;
	const int	 STREAM_SOCKS5_AUTH	= 3;
#endif

#ifndef IOLIB_MODES
	#define IOLIB_MODES

	const int	 MODE_SOCKET_BLOCKING		= 0;
	const int	 MODE_SOCKET_NONBLOCKING	= 1;
#endif
